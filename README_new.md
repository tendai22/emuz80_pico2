...
Z80 と RP2350/RP2040 を用いた3種類のモジュール(WeAct RP2350 CoreBoard/AE-RP2040/自作RP2350-Zero改)の2チップ構成基板を作成し、そのうえで動くファームウェアを本リポジトリで提供しています。

以下のブランチを提供している。

* `develop`: EMUZ80_RP2350B_PCB 基板用。
* `ae_rp2040`: 秋月電子 AE-RP2040 搭載基板用。
* `rp2350_zero`: 自作RP2350-Zero改造基板用。
